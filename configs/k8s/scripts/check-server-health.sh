...
main() {
	...
	# Run all checks
	local fstab_result mem_result disk_result k3s_result systemd_result swap_result vpn_result
	...
	vpn_result=$(check_vpn) || warnings+=("vpn:$vpn_result")
