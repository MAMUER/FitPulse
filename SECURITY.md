...
| **user-service** `cmd/user-service/main.go:839,1766,2388,821` | `// NOSONAR go:S2077` — SQL queries с валидированными константами `tableName`/`idField`/`column` | SonarQube false positive: имена таблиц/колонок — валидированные константы, не пользовательский ввод | Убрать suppression после обновления SonarQube Go plugin |
