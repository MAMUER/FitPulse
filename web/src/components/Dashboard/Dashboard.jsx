...
import { getBiometricRecords, classifyState, getTrainingPlans, getPlan } from '../../utils/api';
...
export default function Dashboard() {
  ...
  const [aiRecommendation, setAiRecommendation] = useState('Загрузка рекомендаций...');
  const [aiDescription, setAiDescription] = useState('Анализируем ваши биометрические данные');
  ...
  const loadDashboard = async () => {
    try {
      ...
      if (sleepData.status === 'fulfilled' && sleepData.value.records?.length > 0) {
        ...
        setSleepValue(Number.isInteger(sleepVal) ? sleepVal : sleepVal.toFixed(1));
      }
          ...
          try {
            ...
            if (weeks.length > 0) {
              ...
              if (todayWorkoutData) {
                ...
                const typeLabel = trainingTypes[todayWorkoutData.training_type] || '';
                let exercisesHtml = '';
  ...
  return (
    <div className="view active">
      <section className="health-summary">
        <div className="summary-card heart-rate">
          ...
          <div className="card-data">
            ...
            <span className="card-value" id="hrValue">{hrValue}</span>
        ...
        <div className="summary-card spo2">
          ...
          <div className="card-data">
            ...
            <span className="card-value" id="spo2Value">{spo2Value}</span>
        ...
        <div className="summary-card sleep">
          ...
          <div className="card-data">
            ...
            <span className="card-value" id="sleepValue">{sleepValue}</span>
        ...
        <div className="summary-card bp">
          ...
          <div className="card-data">
            ...
            <span className="card-value" id="bpValue">{bpValue}</span>
      ...
      <section className="today-section">
        ...
        <div id="todayWorkout" className="workout-card" dangerouslySetInnerHTML={{ __html: todayWorkout || '<div className="workout-placeholder"><p>Сгенерируйте программу тренировок в разделе "Тренировки"</p></div>' }} />
      </section>
    </div>
  );
}
