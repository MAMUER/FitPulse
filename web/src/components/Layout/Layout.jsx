...
export default function Layout() {
  ...
  const tabs = [
    ...
    { path: '/training', icon: 'training', label: 'Тренировки', view: 'training' },
    { path: '/devices', icon: 'devices', label: 'Устройства', view: 'devices' },
    { path: '/achievements', icon: 'achievements', label: 'Достижения', view: 'achievements' },
  ...
  return (
    <div className="app-layout">
      <header className="top-bar">
        <h2>{getPageTitle()}</h2>
        <button id="logoutBtn" className="btn-icon" onClick={logout} aria-label="Выйти">
