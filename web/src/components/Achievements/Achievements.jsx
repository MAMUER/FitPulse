...
export default function Achievements() {
          ...
          datasets: [
            {
              ...
              data: progressData.map(
                (p) => p.completed_workouts ?? p.count ?? p.value ?? 0
              ),
  ...
  const competitions = [
    ...
    },
    {
      ...
      desc: 'Тренируйтесь 3 дня подряд',
      status: 'upcoming',
      participants: 1,
      rank: null,
    },
    {
      ...
      desc: 'Тренируйтесь 20 дней в месяце',
      status: 'upcoming',
      participants: 1,
      rank: null,
    },
            ...
            return (
              ...
              >
                <div className='achievement-icon'>
                  {a.icon_url || iconMap[a.achievement_id] || '🏆'}
                </div>
        ...
        {competitions.map((c) => (
          <div key={c.name} className='competition-card'>
            <div className='competition-header'>
              ...
              <span className={`competition-status ${c.status}`}>
