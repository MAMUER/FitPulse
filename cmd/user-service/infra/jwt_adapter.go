// Package infra provides infrastructure implementations for the user service.
...
// It is the bridge between the user service's application layer and the JWT infrastructure.
