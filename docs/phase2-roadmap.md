...
5. **Миграция на корпоративную почту**: см. раздел 12 (замена личного email на `security@fitpulse.app` с hardware 2FA).
...
- Личный email заменён на корпоративный alias (см. раздел 12).
