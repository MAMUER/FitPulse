...
Обеспечить персистентное хранение OAuth-токенов, учёт состояния синхронизации и audit trail операций с устройствами. Прямое хранение токенов в Valkey недостаточно надёжно и не покрывает сценарии rollover, отзыва доступа и аудита.
