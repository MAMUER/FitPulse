...
Frontend начал оформляться как SPA на vanilla JS/ES2022 с мобильным viewport-first дизайном. Требовалось задокументировать экраны, элементы, API-интеграцию и UI-токены, чтобы разработка шла согласованно с бэкенд-контрактами и безопасными практиками.
