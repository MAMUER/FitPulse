...
Проект требует надёжной интеграции с носимыми устройствами без использования прямых vendor-specific API. Архитектура должна поддерживать устройства из нескольких экосистем и нормализовать входные биометрические данные для последующих ML- и тренировочных сервисов.
...
- поддерживает как адаптеры уровня устройств, так и единые платформенные адаптеры;
